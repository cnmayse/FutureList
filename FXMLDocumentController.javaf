...
public class FXMLDocumentController implements Initializable {
    ...
    private void handleGenerateListButtonAction(ActionEvent event){
        ...
        queryResult  = purchaseData.query(
                QueryStartDate.getValue(), 
                QueryEndDate.getValue(), 
                QueryItemName.getText(), 
                null, 
                (StoreName) QueryStoreName.getValue(),
    ...
    public void initialize(URL url, ResourceBundle rb) {   
        ...
        UpcomingPurchases();        
        AddMessageDate.setText("Add New Items for " + newDate.getMonth() + " " +  newDate.getDayOfMonth() + ", " + newDate.getYear());    
        AddPurchasesDateLabel.setText("All Purchases made on " + newDate.getMonth() + " " +  newDate.getDayOfMonth() + ", " + newDate.getYear());
        initAddItems();     
    }    
    /**
    ...
    public void UpcomingPurchases(){
        ...
        for(int i =0; i < itemNameArr.size(); i ++){            
            ...
            if(predictPurchases.getPurchaseDate().equals(todayDate) || predictPurchases.getPurchaseDate().isBefore(todayDate)){
                Day1Text.setText(Day1Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(1))){
                Day2Text.setText(Day2Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(2))){
                Day3Text.setText(Day3Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(3))){
                Day4Text.setText(Day4Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(4))){                
                Day5Text.setText(Day5Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(5))){
                Day6Text.setText(Day6Text.getText() + "\n  " + predictPurchases.getItemName());
            }
            else if(predictPurchases.getPurchaseDate().equals(todayDate.plusDays(6))){
                Day7Text.setText(Day7Text.getText() + "\n  " + predictPurchases.getItemName());
            }
        }        
    }
    ...
    private void mergeQuery(ArrayList<Purchase> left, ArrayList<Purchase> right, ArrayList<Purchase> list){
        ...
        while(leftIndex < left.size() && rightIndex < right.size()){
            if((left.get(leftIndex).getPurchaseDate()).isBefore(right.get(rightIndex).getPurchaseDate())){
